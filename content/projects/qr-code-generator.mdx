...
description: 这是二维码生成 api 的 cloudflare workers 部署  同时也是解决 CORS 的样板文件
links:
  github: https://github.com/lushi78778/qr-code-generator
  demo: https://api-cf.ewlgc.top
date: 2023-12-25T04:18:20Z
source: github
---

> ⚙️ 本条目由 scripts/sync-projects.mjs 自动生成，来源：https://github.com/lushi78778/qr-code-generator
