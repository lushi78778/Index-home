...
const typeStyle: Record<
  CalloutType,
  { icon: React.ComponentType<any>; className: string; label: string }
> = {
  info: {
    icon: Info,
    className:
      'border-sky-300 bg-sky-50 text-sky-900 dark:border-sky-700/60 dark:bg-sky-950/40 dark:text-sky-100',
    label: '提示',
  },
  tip: {
    icon: Lightbulb,
